  ...
  public static void main(String[] args) throws RestApiException, IOException,
    ...
    for (int currentIndex = totalPatchSets; currentIndex > 0; currentIndex--) {
      Map<String, List<CommentInfo>> comments =
          gerritApi.changes().id(gerritProperties.changeId).revision(currentIndex).comments();
    ...
    System.out.println(
        InstanceHolder.getObjectMapper().writeValueAsString(outputChange.unansweredComments));
  }
